 ...
 * Exp $ $Revision: 4418 $ $Date: 2006-02-13 23:39:31 +0100 (Mon, 13 Feb 2006) $
 * 
 * ==============================================================================
 ...
 * wicket-auth-roles package based on wicket metadata. For instance, use like:
 * 
 * <pre>
 ...
 */
public class MetaDataRoleAuthorizationStrategy extends
	 ...
	 */
	public static final MetaDataKey ACTION_PERMISSIONS = new MetaDataKey(
	...
	public static final void authorize(
			final Class<? extends Component> componentClass, final String roles)
	{
	 ...
	 */
	public static final void authorize(final Component component,
			final Action action, final String roles)
	{
	 ...
	 *            The component class
	 */
	public static final void authorizeAll(
	 ...
	 *            The action to authorize
	 */
	public static final void authorizeAll(final Component component,
			final Action action)
	{
		ActionPermissions permissions = (ActionPermissions) component
				.getMetaData(ACTION_PERMISSIONS);
	...
	public static final void unauthorize(
			final Class<? extends Component> componentClass, final String roles)
	{
		final InstantiationPermissions permissions = (InstantiationPermissions) Application
				.get().getMetaData(INSTANTIATION_PERMISSIONS);
		if (permissions != null)
		{
	 ...
	 */
	public static final void unauthorize(final Component component,
			final Action action, final String roles)
	{
	 ...
	 *            The component class
	 */
	public static final void unauthorizeAll(
	 ...
	 *            the action to authorize
	 */
	public static final void unauthorizeAll(final Component component,
			final Action action)
	{
	 ...
	 */
	public MetaDataRoleAuthorizationStrategy(
			...
			final Action action)
	{
		if (component == null)
		{
			throw new IllegalArgumentException(
					"argument component has to be not null");
		}
		if (action == null)
		{
			throw new IllegalArgumentException(
					"argument action has to be not null");
		}
	...
	public boolean isInstantiationAuthorized(final Class componentClass)
	{
		...
		{
			throw new IllegalArgumentException(
					"argument componentClass must be of type "
	 ...
	 */
	private static Roles rolesAuthorizedToPerformAction(
			final Component component, final Action action)
	{
		final ActionPermissions permissions = (ActionPermissions) component
				.getMetaData(ACTION_PERMISSIONS);
		if (permissions != null)
