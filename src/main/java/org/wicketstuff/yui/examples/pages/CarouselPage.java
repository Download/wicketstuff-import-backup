...
public class CarouselPage extends WicketExamplePage
{
	...
	public CarouselPage()
	{
		List<String> list = Arrays.asList(new String[] { "images/bangkok.jpg", "images/hk.jpg", "images/jakarta.jpg",
				"images/sgp.jpg", "images/makati.jpg" });

		add(new Carousel("carousel", list)
		{
			...
			protected String getOpts()
			{
				...
				attributes.add(new Attributes("animation", new Attributes("speed", 0.4F).add("effect",
						Easing.easeBothStrong.function(), false).toString()));
