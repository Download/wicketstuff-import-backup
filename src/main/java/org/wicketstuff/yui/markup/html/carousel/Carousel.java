...
public class Carousel extends Panel implements IHeaderContributor
{
	...
	private static final String SKIN = "sam";

	private WebMarkupContainer carousel;

	@SuppressWarnings("unchecked")
	public Carousel(String id, List list)
	{
		super(id);

		add(YuiHeaderContributor.forModule("carousel", DEPENDENCIES, DEBUG, BUILD, SKIN));

		WebMarkupContainer container;
		add(container = new WebMarkupContainer("skin_container")
		{
			private static final long serialVersionUID = 1L;
			...
			protected void onComponentTag(ComponentTag tag)
			{
				...
				tag.addBehavior(new AttributeModifier("class", true, new Model("yui-skin-" + SKIN)));
			}
		});

		container.add(carousel = new WebMarkupContainer("carousel_container"));
	...
	public void renderHead(IHeaderResponse response)
	{
		...
		buffer.append("var ").append(getCarouselVar()).append(" = new YAHOO.widget.Carousel(").append("\"").append(
				getCarouselId()).append("\",").append(getOpts()).append(");");
	...
	/**
	 * Override this method to provde own customised
	 * options...use these Options... { animation {} , }
	 * 
